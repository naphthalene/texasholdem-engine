...
/**
 * This class is the brains of your bot.
 * Make your calculations here and return the best move with GetMove
 */
public class BotStarter implements Bot {

    /**
     * Implement this method to return the best move you can.
     * Currently it will return a raise the ordinal value
     * of one of our cards is higher than 9, a call when one of the
     * cards has a higher ordinal value than 5 and a check otherwise.
     * @param state : The current state of your bot, with all the (parsed)
     *                information given by the engine
